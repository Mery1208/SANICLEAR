  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">1. Introducción</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">2. Datos que Recopilamos</h2>
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">3. Uso de los Datos</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">4. Protección de Datos</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">5. Tus Derechos</h2>
        <p className="text-gray-600">
          Puedes ejercer tu derecho de acceso, rectificación, supresión y oposición contactando con el administrador de tu entidad.
        </p>
        
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">6. contacto</h2>
        <p className="text-gray-600">
