  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">1. Medidas de Seguridad</h2>
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">2. Protección de Datos</h2>
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">3. Multi-Tenant</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">4. Recomendaciones</h2>
        <ul className="list-disc pl-5 text-gray-600 space-y-2">
