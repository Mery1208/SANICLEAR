  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-6 shadow-sm space-y-4 transition-colors">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">1. Aceptación de Términos</h2>
        <p className="text-gray-600 dark:text-slate-300">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">2. Uso del Servicio</h2>
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">3. Responsabilidades del Usuario</h2>
        <p className="text-gray-600 dark:text-slate-300">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">4. Limitación de Responsabilidad</h2>
        <p className="text-gray-600 dark:text-slate-300">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">5. Propiedad Intelectual</h2>
        <p className="text-gray-600 dark:text-slate-300">
          Todos los derechos de propiedad intelectual de Saniclear y su contenido son propiedad de la empresa desarrolladora.
        </p>
        
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">6. Modificaciones</h2>
        <p className="text-gray-600 dark:text-slate-300">
