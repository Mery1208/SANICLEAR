  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">1. ¿Qué son las Cookies?</h2>
        <p className="text-gray-600">
          Las cookies son pequeños archivos de texto que se almacenan en tu dispositivo cuando usas una aplicación web.
        </p>
        
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">2. Cookies que Utilizamos</h2>
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">3. Gestión de Cookies</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">4. Cookies de Terceros</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4 mb-3">5. Actualizaciones</h2>
        <p className="text-gray-600">
