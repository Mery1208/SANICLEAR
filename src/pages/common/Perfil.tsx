            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="flex flex-col gap-1.5">
                ...
                <input value={form.nombre} onChange={e => setForm({ ...form, nombre: e.target.value })}
                  className="w-full border border-gray-200 rounded-2xl bg-gray-100 shadow-sm px-5 py-3.5 text-sm font-semibold text-[#1e3a5f] focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all" />
              </div>
              <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input value={usuario.email || ""} disabled
                  className="w-full border border-gray-200 rounded-2xl bg-white px-5 py-3.5 text-sm font-semibold text-gray-500 cursor-not-allowed" />
              </div>
              {entidadNombre && (
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    value={entidadNombre}
                    disabled
                    className="w-full border border-gray-100 rounded-2xl bg-gray-50 px-5 py-3.5 text-sm font-semibold text-[#1e3a5f] cursor-not-allowed"
                  />
                </div>
              )}
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex flex-col gap-1.5 md:col-span-2">
                  ...
                  <div className="relative">
                    <input type={showPassActual ? "text" : "password"} value={form.passwordActual}
                      ...
                      className="w-full border border-gray-200 rounded-2xl bg-gray-100 shadow-sm px-5 pr-12 py-3.5 text-sm font-semibold text-[#1e3a5f] focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all" />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input type={showPassConfirmar ? "text" : "password"} value={form.passwordConfirmar}
                    ...
                    className={`w-full border rounded-2xl bg-gray-100 shadow-sm px-5 pr-12 py-3.5 text-sm font-semibold text-[#1e3a5f] focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all ${form.passwordConfirmar && form.passwordNueva !== form.passwordConfirmar ? 'border-red-300 focus:ring-red-200' : 'border-gray-200'}`} />
