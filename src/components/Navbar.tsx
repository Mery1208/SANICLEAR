...
const Navbar: React.FC = () => {
  return (
    <nav className="flex justify-between items-center py-2 px-3 sm:py-3 sm:px-4 md:py-4 md:px-8 bg-white shadow-sm sticky top-0 z-50 font-inherit">
      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
        <Link to="/" className="text-slate-800 font-medium no-underline transition-colors duration-300 hover:text-blue-600 text-sm md:text-base">
          Inicio
        </Link>
