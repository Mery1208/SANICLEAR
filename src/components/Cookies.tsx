  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4">2. Cookies utilizadas en este sitio web</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4">3. Desactivación o eliminación de cookies</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] mt-4">4. Contacto</h2>
        <p className="text-gray-600">
