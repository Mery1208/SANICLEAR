  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-6 shadow-sm space-y-4 transition-colors">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">1. ¿Qué son las cookies?</h2>
        <p className="text-gray-600 dark:text-slate-300">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">2. Cookies utilizadas en este sitio web</h2>
        <p className="text-gray-600 dark:text-slate-300">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">3. Desactivación o eliminación de cookies</h2>
        <p className="text-gray-600 dark:text-slate-300">
        ...
        <h2 className="text-xl font-bold text-[#1e3a5f] dark:text-blue-400 mt-4 mb-3 transition-colors">4. Contacto</h2>
        <p className="text-gray-600 dark:text-slate-300">
